...
declare function transfer(txParams: {
  /**
   * Amount to transfer in minimal units. E.x. for zbs 100000000 equals 1.0 Zbs
   */
  amount: number,
  /**
  ...
  recipient: string,
  /**
   *  Asset Id to transfer, in case you want to transfer ZBS use default, default: ''
   */
  assetId?: string,
  /**
  ...
  attachment?: string = '',
  /**
   * Asset Id to pay fee with, in case you want to pay fee with ZBS use default, default: ''
   */
  feeAssetId?: string = 'ZBS',
   /**
   * Account public key from which this tx should be sent. Default to the one who signs tx
   */
  senderPublicKey?: string,
...
/**
 * Sends transaction to the 0bsNetwork using env.API_BASE endpoint.
